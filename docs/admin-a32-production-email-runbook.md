...
automated tests, Vercel Preview, and the isolated Staging project always suppress operational
customer mail. This runbook authorizes no migration, environment change or real email.
...
1. Review and apply `20260721151023_admin_invitation_delivery_confirmation.sql` and
   `20260729120000_shipping_confirmation_safety.sql` in timestamp order through the normal
